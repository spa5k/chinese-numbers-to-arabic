import { toArabicString } from "../src/modules";
...
const ToArabicTests = [
  ...
  {
    before: "這款車的價格從34.5萬港幣到55.4萬港幣。",
    after: "這款車的價格從345000港幣到554000港幣。",
  },
...
describe("To Arabic", () => {
  ToArabicTests.forEach((i, index) => {
    test(`to int ${index + 1}`, () => {
      expect(toArabicString(i.before)).toBe(i.after);
    });
  });
});
